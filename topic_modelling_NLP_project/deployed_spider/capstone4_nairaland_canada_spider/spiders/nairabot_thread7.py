...
#see comments at the top of spider 6a
class Nairabotpg1Spider(scrapy.Spider):
    name = 'nairabot_thread7' 
    ...
    page0 = 'https://www.nairaland.com/5031893/canadian-express-entry-federal-skilled' #first page, the url carries no page number
    #list of pages'urls
    start_urls = [page0] + ['https://www.nairaland.com/5031893/canadian-express-entry-federal-skilled/{page_num}'.format(page_num=page_num)
