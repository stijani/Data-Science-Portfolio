...
class Nairabotpg1Spider(scrapy.Spider):
    ...
    page0 = 'https://www.nairaland.com/4657743/canadian-express-entry-federal-skilled/' #first page, the url carries no page number
    #list of pages'urls
    start_urls = [page0] + ['https://www.nairaland.com/4657743/canadian-express-entry-federal-skilled/{page_num}'.format(page_num=page_num)
                  for page_num in range(1, 612)]
